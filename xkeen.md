...
Важно! Флешка всегда будет находиться в роутере, так как ресурсы роутера не позволяют работу VPN без флешки.
>
...
>
> После этого откройте сайт **[для генерации outbounds.json](https://recobalt.github.io/xkeen-config-generator/)** и вставьте скопированный ключ в соответствующее поле.
> 
